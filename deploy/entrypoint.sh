#!/bin/bash
# deploy/entrypoint.sh — the dense image's entrypoint, vendored for reference.
#
...
# (this file mirrors that one, paths and log prefixes included; nothing in this
# repository builds or runs it).
#

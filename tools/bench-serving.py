...
ROOT = os.environ.get("SUPERFAST_ROOT", os.path.dirname(os.path.dirname(
    os.path.abspath(__file__))))
PROMPTS_PATH = os.environ.get("SUPERFAST_PROMPTS",
                              os.path.join(ROOT, "tools", "eval-prompts.json"))
API_CTR = os.environ.get("SUPERFAST_API_CTR", "superfast-api")
# SUPERFAST_API_LOG makes this script runnable FROM INSIDE the serving
...
API_LOG = os.environ.get("SUPERFAST_API_LOG", "")
...
def _api_output():
    ...
    In-container (SUPERFAST_API_LOG set) we read the teed log file; on the box

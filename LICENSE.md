# superfast — End User License Agreement

**Version 0.1 · Effective 25 August 2026**

This Agreement is between you ("**You**") and **Peonist** ("we", "us"), and
governs your use of **superfast** (the "**Software**") — the container image
published by us containing the superfast inference engine binary, its serving
...
superfast engine binary, the serving front-end, the benchmark tooling, and the
container packaging.
...
1. **Redistribute a modified Software image to third parties**, or distribute
   a derivative and present it as superfast. Modifying your own copy for your
   own use is permitted; passing the result to others as superfast is not.
2. **Remove, obscure, or alter** the copyright notices, this Agreement, or
   `THIRD-PARTY-NOTICES.md`.
3. **Use our names or marks** — "Peonist", "superfast" — to endorse or promote
   your products without our written permission. Factually stating that your
   product runs on superfast is fine and needs no permission.
...
The second is a technical necessity, not a legal formality. superfast's decode
...
**Contact:** open an issue at https://github.com/peonist-ai/superfast-server
